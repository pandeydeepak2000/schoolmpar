...
@section('title', 'My Profile & Security Settings')
...
<div style="margin-bottom:24px;">
    ...
    <p style="font-size:13px; color:#64748b; margin:0;">
        Manage your verified contact credentials, security password, and two-factor authentication (2FA)
    </p>
</div>
...
<div style="display:grid; grid-template-columns:1fr 1fr; gap:20px;">
    ...
    <div style="background:#fff; border:1.5px solid #e8ecf4; border-radius:14px; padding:24px; box-shadow:0 2px 8px rgba(0,0,0,0.02);">
        <div style="margin-bottom:16px; padding-bottom:12px; border-bottom:1.5px solid #f1f5f9; display:flex; align-items:center; gap:10px;">
            ...
            <div>
                <h3 style="font-size:15px; font-weight:800; color:#0f2d59; margin:0;">Applicant Contact Profile</h3>
                <span style="font-size:11.5px; color:#64748b;">Your verified details used for admission forms & visit bookings</span>
            </div>
        </div>
        ...
        <form action="{{ route('parent.profile.update') }}" method="POST">
            ...
            <div style="margin-bottom:14px;">
                <label style="font-size:12px; font-weight:700; color:#475569; display:block; margin-bottom:5px;">Full Name *</label>
            ...
            <div style="margin-bottom:14px;">
                ...
                <span style="font-size:11px; color:#94a3b8; margin-top:3px; display:block;">🔒 Registered email address cannot be changed directly.</span>
            </div>

            <div style="margin-bottom:20px;">
                <label style="font-size:12px; font-weight:700; color:#475569; display:block; margin-bottom:5px;">Mobile / WhatsApp Number</label>
    ...
    <div style="display:flex; flex-direction:column; gap:20px;">
        ...
        <div style="background:#fff; border:1.5px solid #e8ecf4; border-radius:14px; padding:24px; box-shadow:0 2px 8px rgba(0,0,0,0.02);">
            <div style="margin-bottom:16px; padding-bottom:12px; border-bottom:1.5px solid #f1f5f9; display:flex; align-items:center; gap:10px;">
                ...
                <div>
                    <h3 style="font-size:15px; font-weight:800; color:#0f2d59; margin:0;">Update Security Password</h3>
                    <span style="font-size:11.5px; color:#64748b;">Keep your account credentials safe</span>
                </div>
            </div>
        ...
        <div style="background:#fff; border:1.5px solid #e8ecf4; border-radius:14px; padding:20px; box-shadow:0 2px 8px rgba(0,0,0,0.02);">
            <div style="display:flex; justify-content:space-between; align-items:center;">
                ...
                <form action="{{ route('parent.two_factor.toggle') }}" method="POST">
                    @csrf
                    @method('PATCH')
