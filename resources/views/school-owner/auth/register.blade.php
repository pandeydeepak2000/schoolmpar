...
<body>
    ...
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <form id="partnerRegisterForm" action="{{ route('school-owner.register.post') }}" method="POST" style="margin-top:14px;">
                @csrf
            ...
            <div class="signin-section">
                <p class="signin-text">Already registered your school, or prefer 1-Click Login?</p>
                <a href="/login" class="btn-signin-link">
                    <i class="fa-solid fa-right-to-bracket me-1"></i> Sign In to Existing School Account
                </a>
            </div>

            <div class="auth-footer-note">
                🔒 Verified Patna School Partners Network • Support: <strong style="color:var(--navy);">partner@schoolmapr.com</strong>
            </div>
